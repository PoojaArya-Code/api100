...
namespace LibraryApi.Controllers
{
    public class StatusController : Controller
    {
        ...
        public ActionResult GetEmploeeSalary(int employeeId)
        {
            if (employeeId < 1)
            {
                return NotFound();
        ...
        //c. Add some data to the query string at teh end of the url e.g. Get /shoes?color=blue
        [HttpGet("shoes")]
       ...
       [HttpPost("employees")]
       public ActionResult AddAdEmployee([FromBody] NeWEmployee employee, [FromServices] IGenerateEmployeeIds idGenerator)
        {
